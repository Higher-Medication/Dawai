...
public final class User implements Model {
  ...
  public static final QueryField TEST = field("User", "test");
  private final @ModelField(targetType="ID", isRequired = true) String id;
  private final @ModelField(targetType="String", isRequired = true) String name;
  private final @ModelField(targetType="AWSDate") Temporal.Date dateOfBirth;
  ...
  public Temporal.Date getDateOfBirth() {
      return dateOfBirth;
  }
  ...
  private User(String id, String name, Temporal.Date dateOfBirth, String test) {
    this.id = id;
    this.name = name;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), user.getId()) &&
              ...
              ObjectsCompat.equals(getTest(), user.getTest()) &&
  ...
  public interface BuildStep {
    ...
    BuildStep dateOfBirth(Temporal.Date dateOfBirth);
  ...
  public static class Builder implements NameStep, BuildStep {
    private String id;
    private String name;
    private Temporal.Date dateOfBirth;
    private String test;
    @Override
     public User build() {
    ...
    @Override
     public BuildStep dateOfBirth(Temporal.Date dateOfBirth) {
        this.dateOfBirth = dateOfBirth;
        return this;
    }
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, Temporal.Date dateOfBirth, String test) {
      super.id(id);
      super.name(name)
    ...
    @Override
     public CopyOfBuilder dateOfBirth(Temporal.Date dateOfBirth) {
